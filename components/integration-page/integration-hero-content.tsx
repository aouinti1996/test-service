  ...
  return (
    <div className="relative z-10 flex w-full max-w-[700px] flex-col gap-4 xl:w-[700px] xl:gap-6">
      ...
      <h1 className="text-2xl font-bold leading-8 xl:text-heading-h1-bold">
        <span className="text-text-heading">Add Top-Up to </span>
        <span className="text-primary-600 xl:text-primary-default">Your App</span>
      </h1>

      <p className="max-w-[580px] text-sm leading-5 text-text-body xl:text-body-small-regular">
        Integrate mobile recharge, bundles, and digital wallet services into
        your platform using Active Services&apos; reliable API — built for
        Afghanistan.
      </p>
    </div>
  );
